  ...
  return (
    <div style={{
      ...
      <div className="animate-fade-up" style={{
        ...
        <p style={{ fontSize: "13px", color: "var(--text-muted)", marginBottom: "36px", lineHeight: 1.7, fontWeight: 300 }}>
          落ち込みや不安の"きっかけ"を<br />見つけるための記録ツール
        </p>

        {sent ? (
          <div style={{
            background: "rgba(152,232,212,0.1)", border: "1px solid var(--accent3)",
            borderRadius: "12px", padding: "20px",
            color: "var(--accent3)", fontSize: "14px", lineHeight: 1.7,
          }}>
            ✦ メールを送信しました<br />
          ...
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
              ...
              <span style={{ fontSize: "11px", color: "var(--text-muted)" }}>または</span>
              <div style={{ flex: 1, height: "1px", background: "var(--border)" }} />
            </div>
